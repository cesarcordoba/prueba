...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.ENUM, values: ['normal', 'portada', 'otro'], defaultValue: 'normal' }),
    __metadata("design:type", String)
], Imagen.prototype, "tipo", void 0);
__decorate([
    sequelize_typescript_1.Column(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
], Imagen.prototype, "key", void 0);
Imagen = __decorate([
