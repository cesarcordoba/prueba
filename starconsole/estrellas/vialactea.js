...
var estrella =  {
    ...
    inversionista : require('./front/inversionista.js'),
    contratista : require('./front/contratista.js'),
...
module.exports = (modelos) => {
    ...
    return {
        ...
        inversionista : (modelos) => estrella.inversionista(modelos, escribir('../1.-frontend/src/app/modulos/inversionista/inversionista.module.ts')),
        contratista : (modelos) => estrella.contratista(modelos, escribir('../1.-frontend/src/app/modulos/contratista/contratista.module.ts')),
